...
$.extend(Countdown.prototype, {
	...
	Cufon.replace('.days', { fontFamily: 'ghettomarquee' });
	Cufon.replace('.seconds', { fontFamily: 'ghettomarquee' });
	Cufon.replace('.minutes', { fontFamily: 'ghettomarquee' });
	Cufon.replace('.hours', { fontFamily: 'ghettomarquee' });
	Cufon.replace('.duration', { fontFamily: 'Harabara' });
	},
